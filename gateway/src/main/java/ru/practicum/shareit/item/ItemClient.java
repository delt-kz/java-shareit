...
public class ItemClient extends BaseClient {
    ...
    public ResponseEntity<Object> update(long ownerId, Long itemId, CreateItemDto patch) {
    ...
    public ResponseEntity<Object> createComment(long userId, Long itemId, CreateCommentDto dto) {
